...
type BookInfo struct {
	...
	CategoryID            uint64    `gorm:"column:category_id" json:"categoryId"`                         // 类别ID
	...
	AuthorID              uint64    `gorm:"column:author_id" json:"authorId"`                             // 作家ID
	...
	VisitCount            uint64    `gorm:"column:visit_count" json:"visitCount"`                         // 点击量
	WordCount             int       `gorm:"column:word_count" json:"wordCount"`                           // 总字数
	CommentCount          int       `gorm:"column:comment_count" json:"commentCount"`                     // 评论数
	LastChapterID         uint64    `gorm:"column:last_chapter_id" json:"lastChapterId"`                  // 最新章节ID
